...
def Extract_Permeability_value_from_materials_and_finishes(ifc_file_path):
    # 打开IFC文件
        ...
        if material_name == 'Pest_WirelessPropagation':
            ...
            for prop in properties:
                ...
                if param_name == 'Permeability':
                    ...
                    return param_value  # 返回Permeability的值

# 调用函数，传入IFC文件的路径
ifc_file_path = r'path of ifc file'
Permeability_value = Extract_Permeability_value_from_materials_and_finishes(ifc_file_path)
if Permeability_value is not None:
    print("Permeability value extracted:", Permeability_value)
else:
    print("No Permeability value found for 'Pest_WirelessPropagation'.")
